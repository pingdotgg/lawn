...
export default function Homepage() {
  ...
  return (
    ...
    >
      {/* Minimal nav */}
      <nav
        className={`fixed w-full top-0 z-50 px-6 py-4 flex justify-between items-center transition-all duration-200 ${scrolled ? "bg-[#f0f0e8] text-[#1a1a1a] border-b-2 border-[#1a1a1a]" : "bg-transparent text-[#f0f0e8] drop-shadow-md"}`}
      >
      ...
      <section className="border-b-2 border-[#1a1a1a] bg-[#f0f0e8]">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 divide-y-2 md:divide-y-0 md:divide-x-2 divide-[#1a1a1a]">
          {[
            ...
            >
              <div className="text-sm font-black text-[#888] group-hover:text-[#7cb87c] mb-8">
                /{item.id}
              </div>
            ...
            {[
              ...
              >
                ...
                <div className="p-8 flex-grow flex flex-col">
                  <h3 className="text-3xl md:text-4xl font-black uppercase tracking-tighter mb-4 text-[#2d5a2d]">
                    {item.action}
                  </h3>
            ...
            <div className="lg:w-2/3">
              <div className="grid grid-cols-1 md:grid-cols-2 border-2 border-[#1a1a1a] shadow-[12px_12px_0px_0px_var(--shadow-color)]">
                ...
                <div className="p-8 md:p-12 bg-[#1a1a1a] text-[#f0f0e8]">
                  <div className="text-sm font-bold tracking-widest text-[#7cb87c] mb-2">
                    THE SOLUTION
                  </div>
                  <div className="text-5xl font-black tracking-tighter mb-8 text-[#7cb87c]">
                    lawn
                  </div>
      ...
      <section className="px-6 py-32 bg-[#2d5a2d] text-[#f0f0e8] border-b-2 border-[#1a1a1a]">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <a
            ...
            className="inline-block border-2 border-[#f0f0e8] px-6 py-3 font-bold uppercase tracking-wider hover:bg-[#f0f0e8] hover:text-[#2d5a2d] transition-colors"
          >
            — Theo
          </a>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center items-center">
            ...
            <div className="bg-[#1a1a1a] text-[#f0f0e8] border-2 border-[#1a1a1a] shadow-[8px_8px_0px_0px_var(--shadow-color)] p-8 w-full max-w-md flex flex-col transform md:-translate-y-4 hover:-translate-y-6 hover:translate-x-2 hover:shadow-[4px_4px_0px_0px_var(--shadow-color)] transition-all">
              ...
              <ul className="space-y-4 text-lg font-bold flex-grow mb-8">
                ...
                <li className="flex items-center gap-3">
                  <span className="text-[#7cb87c] text-2xl">✓</span> 1TB Storage (Whoa)
                </li>
              </ul>
